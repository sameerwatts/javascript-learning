...
// arr.forEach((singleItem, i, arrayOfItems) => {
//   arrayOfItems.push(`item${i + 4}`);
//   // arrayOfItems.pop();
//   // console.log('🙃');
// });
...
//   ['name', 'sameer'],
//   ['age', 22],
//   ['address', '262 shastripark'],
// ];

// // const createObj = (accumulator, current) => {
// //   const [prop, val] = current;
// //   accumulator[prop] = val;
// //   return accumulator;
// // };

// const newObj = {};
// const createObj = ([prop, val]) => {
//   newObj[prop] = val;
// };
// // const personDetailObj = personDetail.reduce(createObj, {});
// const personDetailObj = personDetail.forEach(createObj);
...
const { length } = toppings;
function getToppings(singleTopping, i, originalToppings) {
  // log the toppings
  console.log(singleTopping);
  // log the prev topping if there is
  originalToppings[i - 1] ? console.log(originalToppings[i - 1]) : null;
  // log the next topping if there is
  originalToppings[i + 1] ? console.log(originalToppings[i + 1]) : null;
  // if it's last topping say bye if not say getting topping
  if (length - 1 === i) {
